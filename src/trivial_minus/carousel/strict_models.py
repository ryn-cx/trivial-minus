...
class Datum(BaseModel):
    ...
    content_id_impression: int | str = Field(..., alias='contentIdImpression')
    position: int
    rank_model: None = Field(..., alias='rankModel')
    cms_id: int | str = Field(..., alias='cmsId')
    content: Content | None = None
    id: int | str
    content_id: int | str = Field(..., alias='contentId')
    alt: str
    ...
    badge_label: bool = Field(..., alias='badgeLabel')
    ...
    trailer_content: None = Field(None, alias='trailerContent')
    ...
    content_id_1: None = Field(None, alias='content_id')
